...
import com.zero.ioshop.accountservice.dto.UserDto;
import com.zero.ioshop.accountservice.dto.UserLoginDto;
...
public class UserController {
    ...
    /**
     * returns found users to api
     *
     * @param keyword
     */
    @GetMapping("/keyword")
    public ResponseModel getByKeyword(@Param("keyword") String keyword, @Param("page") Integer page) {
        return userService.findAllByKeyword(keyword);
    }
